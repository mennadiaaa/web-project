const API = "https://web-project-production-5d78.up.railway.app/api/events?category=Entertainment";
...
async function getEvents() {
  try {
    ...
    console.error("Error fetching entertainment events:", err);
    return [];
  }
}
...
async function renderEvents() {
  ...
  if (!events.length) {
    container.innerHTML = "<p>No entertainment events found.</p>";
    return;
  }
